...
class SellScoringEngine:
    ...
    def _fundamental_score(
        ...
        revenue = fundamentals.get("revenue_growth", 0)
        earnings = fundamentals.get("earnings_growth", 0)
        roe = fundamentals.get("roe", 0)
        pe = fundamentals.get("pe", 999)
        pb = fundamentals.get("pb", 999)
        peg = fundamentals.get("peg", 999)
        debt = fundamentals.get("debt_to_equity", 999)
        cash = fundamentals.get("operating_cashflow", 0)

        # Weak fundamentals increase SELL score
